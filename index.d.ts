...
declare module "trials-overlay" {
    ...
    export function setEventCallback(cb: (event: string, ...args: any[]) => void): void; // eslint-disable-line
    ...
    export function translateInputEvent(event: {windowId: number, msg: number, wparam: number, lparam: number}): any; // eslint-disable-line
}
